...
public class ActCodeHoursProcessorTests
{
    ...
    public void Process_WhenCalled_ReturnsExpectedResult(List<ActCodeHours> input, Dictionary<DateOnly, Dictionary<string, (double regHours, double otHours)>> expected)
    {
