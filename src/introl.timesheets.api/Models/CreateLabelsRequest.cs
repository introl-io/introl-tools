...
{
    [SwaggerSchema(Description = "File must be a .xlsx file with the port mappings in the first sheet")]
    public required IFormFile File { get; init; }
    [SwaggerSchema(Description = "Format to use for source port in label. Put column letter in {} to be replaced with the column value. eg. {A}.R{B}.{E}")]
